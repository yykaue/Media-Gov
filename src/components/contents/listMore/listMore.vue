            ...
            <li v-for="(item,index) in msg" :class="{fire:page.index==1&&index<3&&num2==1,new:page.index==1&&index<3&&num2==2}">
                ...
                <div class="clear">
                    ...
                    <p class="fr">
                        ...
                        <span class="sp7" @click="toRouter({nid:item.nid,name:item.source,wid:item.wid})">查看传播效果</span>
                    </p>
                </div>
    ...
    export default {
        ...
        created(){
            ...
            this.minbodylist({
                ...
                pageIndex: 1,
                pageSize: 13,
                order: this.$store.state.listMoreOrder
            })
        },
        methods: {
...
//                本地
            ...
            pageGo: function () {
                var inp = $('.listMore .page input')[0];
                var reg = /\D|\d{6}/g;
                inp.onkeyup = function () {
                    inp.value = inp.value.replace(reg, '');
                };
                var gos = $('.listMore .page .go')[0];
                var that = this;
            ...
            orderChange:function (n) {
                this.num2=n;
                this.$store.state.listMoreOrder=n;
            },
        ...
        computed: {
            ...
            listMoreOrderChange(){
                return this.$store.state.listMoreOrder
            }
        },
        watch: {
            datasChange: {
