<template>
    <div class="bereproduceAnalysis fl">
        <div class="tops">
            <span>被转载量走势</span>
            <span class="p1">直接被转载总量：{{total}}</span>
        </div>
...
<script>
    ...
    export default{
        ...
        methods: {
            // 被转载量走势
            bereproduceAnalysis: function (options) {
                $.ajax({
                    type: "GET",
                    url: this.$store.state.datas.url + 'jusfoun-entmedia/newurlsBtimenews/bereproduceAnalysis?id=' + options.id + '&Wid=' + options.Wid+'&WebName='+options.WebName,
                    data: {},
                    ...
                    success: function (data) {
                        if (data.result == 1) {
                            ...
                            if(data.data.length){
                                ...
                                var op = {
                                    dom: document.getElementById('bereproduce'),
                                    data: [xData, datas1],
                                };
                                this.setECharts(op);
                            }else{
